...
if __name__ == "__main__":
    # Your input tensor (example)
    x = torch.rand((64, 1, 64, 64))  # Single channel, 64x64 input

    # Instantiate the MobileNet model
    model = MobileNetV2(1)

    # Call the test_model function to get predictions
    predictions = test_model(model, x)

    # Print the size of the predictions tensor
